...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _vertx3EventbusClient = __webpack_require__(1);
	...
	var eb = new _vertx3EventbusClient2.default('//' + location.host + '/eventbus');
	eb.onopen = function () {
	
	  eb.registerHandler('app.chat.data.processed', function (err, msg) {
	    if (!err) {
	      ...
	      try {
	        for (var _iterator = msg.body[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	          var entry = _step.value;
	
	
	          var message = entry.message.split("_")[0];
	          var ip = entry.message.split("_")[1];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	!function (factory) {
	  if (true) {
	    // CommonJS loader
	    var SockJS = __webpack_require__(2);
	    if (!SockJS) {
	   ...
	   * @constructor
	   */
	  var EventBus = function EventBus(url, options) {
	    var self = this;
	    ...
	    var getReconnectDelay = function getReconnectDelay() {
	    ...
	    var setupSockJSConnection = function setupSockJSConnection() {
	      ...
	      self.sockJSConn.onmessage = function (e) {
	        ...
	        if (json.replyAddress) {
	          Object.defineProperty(json, 'reply', {
	            value: function value(message, headers, callback) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(50)(transportList);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__webpack_require__(4), __webpack_require__(20), __webpack_require__(30), __webpack_require__(32), __webpack_require__(35)(__webpack_require__(32))
	
	// polling transports
	, __webpack_require__(43), __webpack_require__(35)(__webpack_require__(43)), __webpack_require__(45), __webpack_require__(46), __webpack_require__(35)(__webpack_require__(45)), __webpack_require__(47)];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var utils = __webpack_require__(6),
	    urlUtils = __webpack_require__(9),
	    inherits = __webpack_require__(16),
	    EventEmitter = __webpack_require__(17).EventEmitter,
	    WebsocketDriver = __webpack_require__(19);
	
	var debug = function debug() {};
	if (process.env.NODE_ENV !== 'production') {
	  debug = __webpack_require__(13)('sockjs-client:websocket');
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var debug = function debug() {};
	if (process.env.NODE_ENV !== 'production') {
	  debug = __webpack_require__(13)('sockjs-client:utils:url');
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var inherits = __webpack_require__(16),
	    EventTarget = __webpack_require__(18);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var inherits = __webpack_require__(16),
	    ...
	    XHRLocalObject = __webpack_require__(28),
	    browser = __webpack_require__(29);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var inherits = __webpack_require__(16),
	    urlUtils = __webpack_require__(9),
	    SenderReceiver = __webpack_require__(22);
	
	var debug = function debug() {};
	if (process.env.NODE_ENV !== 'production') {
	  debug = __webpack_require__(13)('sockjs-client:ajax-based');
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var inherits = __webpack_require__(16),
	    urlUtils = __webpack_require__(9),
	    BufferedSender = __webpack_require__(23),
	    Polling = __webpack_require__(24);
	
	var debug = function debug() {};
	if (process.env.NODE_ENV !== 'production') {
	  debug = __webpack_require__(13)('sockjs-client:sender-receiver');
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var debug = function debug() {};
	if (process.env.NODE_ENV !== 'production') {
	  debug = __webpack_require__(13)('sockjs-client:buffered-sender');
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var debug = function debug() {};
	if (process.env.NODE_ENV !== 'production') {
	  debug = __webpack_require__(13)('sockjs-client:polling');
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var debug = function debug() {};
	if (process.env.NODE_ENV !== 'production') {
	  debug = __webpack_require__(13)('sockjs-client:receiver:xhr');
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var inherits = __webpack_require__(16),
	    XhrDriver = __webpack_require__(27);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var debug = function debug() {};
	if (process.env.NODE_ENV !== 'production') {
	  debug = __webpack_require__(13)('sockjs-client:browser:xhr');
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var debug = function debug() {};
	if (process.env.NODE_ENV !== 'production') {
	  debug = __webpack_require__(13)('sockjs-client:sender:xdr');
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var inherits = __webpack_require__(16),
	    AjaxBasedTransport = __webpack_require__(21),
	    EventSourceReceiver = __webpack_require__(33),
	    XHRCorsObject = __webpack_require__(26),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var debug = function debug() {};
	if (process.env.NODE_ENV !== 'production') {
	  debug = __webpack_require__(13)('sockjs-client:receiver:eventsource');
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var inherits = __webpack_require__(16),
	    ...
	    objectUtils = __webpack_require__(42);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var inherits = __webpack_require__(16),
	    ...
	    EventEmitter = __webpack_require__(17).EventEmitter,
	    version = __webpack_require__(40),
	    urlUtils = __webpack_require__(9),
	    iframeUtils = __webpack_require__(41),
	    eventUtils = __webpack_require__(6),
	    random = __webpack_require__(7);
	
	var debug = function debug() {};
	if (process.env.NODE_ENV !== 'production') {
	  debug = __webpack_require__(13)('sockjs-client:transport:iframe');
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var debug = function debug() {};
	if (process.env.NODE_ENV !== 'production') {
	  debug = __webpack_require__(13)('sockjs-client:utils:iframe');
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var inherits = __webpack_require__(16),
	    HtmlfileReceiver = __webpack_require__(44),
	    XHRLocalObject = __webpack_require__(28),
	    AjaxBasedTransport = __webpack_require__(21);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var debug = function debug() {};
	if (process.env.NODE_ENV !== 'production') {
	  debug = __webpack_require__(13)('sockjs-client:receiver:htmlfile');
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var inherits = __webpack_require__(16),
	    SenderReceiver = __webpack_require__(22),
	    JsonpReceiver = __webpack_require__(48),
	    jsonpSender = __webpack_require__(49);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var debug = function debug() {};
	if (process.env.NODE_ENV !== 'production') {
	  debug = __webpack_require__(13)('sockjs-client:receiver:jsonp');
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var debug = function debug() {};
	if (process.env.NODE_ENV !== 'production') {
	  debug = __webpack_require__(13)('sockjs-client:sender:jsonp');
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	SockJS.version = __webpack_require__(40);
	...
	module.exports = function (availableTransports) {
	  ...
	  __webpack_require__(64)(SockJS, availableTransports);
	  return SockJS;
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(5), (function() { return this; }())))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var debug = function debug() {};
	if (process.env.NODE_ENV !== 'production') {
	  debug = __webpack_require__(13)('sockjs-client:utils:transport');
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var EventEmitter = __webpack_require__(17).EventEmitter,
	    ...
	    XHRLocal = __webpack_require__(28),
	    XHRFake = __webpack_require__(60),
	    InfoIframe = __webpack_require__(61),
	    InfoAjax = __webpack_require__(63);
	
	var debug = function debug() {};
	if (process.env.NODE_ENV !== 'production') {
	  debug = __webpack_require__(13)('sockjs-client:info-receiver');
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var EventEmitter = __webpack_require__(17).EventEmitter,
	    ...
	    utils = __webpack_require__(6),
	    IframeTransport = __webpack_require__(36),
	    InfoReceiverIframe = __webpack_require__(62);
	
	var debug = function debug() {};
	if (process.env.NODE_ENV !== 'production') {
	  debug = __webpack_require__(13)('sockjs-client:info-iframe');
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var debug = function debug() {};
	if (process.env.NODE_ENV !== 'production') {
	  debug = __webpack_require__(13)('sockjs-client:info-ajax');
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var urlUtils = __webpack_require__(9),
	    eventUtils = __webpack_require__(6),
	    JSON3 = __webpack_require__(37),
	    FacadeJS = __webpack_require__(65),
	    InfoIframeReceiver = __webpack_require__(62),
	    iframeUtils = __webpack_require__(41),
	    loc = __webpack_require__(56);
	
	var debug = function debug() {};
	if (process.env.NODE_ENV !== 'production') {
	  debug = __webpack_require__(13)('sockjs-client:iframe-bootstrap');
	}
